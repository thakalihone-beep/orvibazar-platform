    ...
    <div style="display: flex; align-items: center; gap: var(--spacing-lg);">
        ...
        <div style="position: relative;" id="categoriesDropdown">
            ...
            <div id="categoriesMenu"
                ...
                <div id="categoryList">
                    <a href="/category/electronics" data-category="electronics"
                        ...
                        <i class="fas fa-laptop" style="margin-right: var(--spacing-sm); width: 20px;"></i> Electronics
                        <span
                            style="float: right; color: var(--color-text-muted); font-size: var(--font-size-xs);">(234)</span>
                    </a>
                    <a href="/category/fashion" data-category="fashion"
                        style="display: block; padding: var(--spacing-sm) var(--spacing-lg); color: var(--color-text-primary); text-decoration: none; transition: all var(--transition-fast);">
                        <i class="fas fa-tshirt" style="margin-right: var(--spacing-sm); width: 20px;"></i> Fashion
                        <span
                            style="float: right; color: var(--color-text-muted); font-size: var(--font-size-xs);">(156)</span>
                    </a>
                    <a href="/category/home" data-category="home"
                        style="display: block; padding: var(--spacing-sm) var(--spacing-lg); color: var(--color-text-primary); text-decoration: none; transition: all var(--transition-fast);">
                        <i class="fas fa-home" style="margin-right: var(--spacing-sm); width: 20px;"></i> Home & Living
                        <span
                            style="float: right; color: var(--color-text-muted); font-size: var(--font-size-xs);">(89)</span>
                    </a>
                    <a href="/category/beauty" data-category="beauty"
                        style="display: block; padding: var(--spacing-sm) var(--spacing-lg); color: var(--color-text-primary); text-decoration: none; transition: all var(--transition-fast);">
                        <i class="fas fa-spa" style="margin-right: var(--spacing-sm); width: 20px;"></i> Beauty <span
                            style="float: right; color: var(--color-text-muted); font-size: var(--font-size-xs);">(67)</span>
                    </a>
                    <a href="/category/sports" data-category="sports"
                        style="display: block; padding: var(--spacing-sm) var(--spacing-lg); color: var(--color-text-primary); text-decoration: none; transition: all var(--transition-fast);">
                        <i class="fas fa-dumbbell" style="margin-right: var(--spacing-sm); width: 20px;"></i> Sports
                        <span
                            style="float: right; color: var(--color-text-muted); font-size: var(--font-size-xs);">(45)</span>
                    </a>
                    <a href="/category/books" data-category="books"
                        style="display: block; padding: var(--spacing-sm) var(--spacing-lg); color: var(--color-text-primary); text-decoration: none; transition: all var(--transition-fast);">
                        <i class="fas fa-book" style="margin-right: var(--spacing-sm); width: 20px;"></i> Books <span
                            style="float: right; color: var(--color-text-muted); font-size: var(--font-size-xs);">(123)</span>
                    </a>
                    <a href="/category/toys" data-category="toys"
                        style="display: block; padding: var(--spacing-sm) var(--spacing-lg); color: var(--color-text-primary); text-decoration: none; transition: all var(--transition-fast);">
                        <i class="fas fa-gamepad" style="margin-right: var(--spacing-sm); width: 20px;"></i> Toys &
                        Games <span
                            style="float: right; color: var(--color-text-muted); font-size: var(--font-size-xs);">(78)</span>
                    </a>
                    <a href="/category/automotive" data-category="automotive"
                        style="display: block; padding: var(--spacing-sm) var(--spacing-lg); color: var(--color-text-primary); text-decoration: none; transition: all var(--transition-fast);">
                        <i class="fas fa-car" style="margin-right: var(--spacing-sm); width: 20px;"></i> Automotive
                        <span
                            style="float: right; color: var(--color-text-muted); font-size: var(--font-size-xs);">(34)</span>
                    </a>
                    <div style="border-top: 1px solid var(--color-border-light); margin: var(--spacing-xs) 0;"></div>
                    <a href="/categories"
    ...
    <div style="display: flex; flex-direction: column; gap: var(--spacing-md);">
        ...
        <div>
            ...
            <div id="mobileCategoriesList" style="display: none; margin-top: var(--spacing-sm);">
                ...
                <a href="/categories"
                    style="display: block; color: var(--color-text-light); text-decoration: none; padding: var(--spacing-sm) var(--spacing-md);">
                    <i class="fas fa-arrow-right" style="margin-right: var(--spacing-sm);"></i> View All
                </a>
            </div>
        </div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Update wishlist count after toggle
        function toggleWishlist(productId, button) {
            // ... existing toggle code ...

            // After toggling, update count
